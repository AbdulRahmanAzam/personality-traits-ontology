...
export function LandingPage({ onStartAssessment, isApiReady, apiError }) {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <section id="about" className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-8">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-10">About This Project</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-slate-50 rounded-2xl p-7 text-center transition-all hover:-translate-y-2 hover:shadow-lg">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="text-lg font-semibold text-slate-900 mb-3">Big Five Model</h3>
            ...
            <div className="bg-slate-50 rounded-2xl p-7 text-center transition-all hover:-translate-y-2 hover:shadow-lg">
              <div className="text-4xl mb-4">🔬</div>
              <h3 className="text-lg font-semibold text-slate-900 mb-3">IPIP-50 Scale</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
            ...
            <div className="bg-slate-50 rounded-2xl p-7 text-center transition-all hover:-translate-y-2 hover:shadow-lg">
              <div className="text-4xl mb-4">🧩</div>
              <h3 className="text-lg font-semibold text-slate-900 mb-3">OWL Ontology</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
      ...
      {/* Traits Section */}
      <section className="bg-linear-to-b from-slate-100 to-slate-200 py-16">
        <div className="max-w-5xl mx-auto px-8">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-10">The Five Personality Dimensions</h2>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
            <div className="bg-white rounded-2xl p-6 text-center shadow-md border-t-4 border-red-500 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Extraversion</h3>
              <p className="text-slate-600 text-xs leading-relaxed">Energy, positive emotions, sociability, and the tendency to seek stimulation.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center shadow-md border-t-4 border-emerald-500 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Agreeableness</h3>
              <p className="text-slate-600 text-xs leading-relaxed">Tendency to be compassionate and cooperative rather than suspicious.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center shadow-md border-t-4 border-blue-500 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Conscientiousness</h3>
              <p className="text-slate-600 text-xs leading-relaxed">Self-discipline, carefulness, and preference for planned behavior.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center shadow-md border-t-4 border-amber-500 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Neuroticism</h3>
              <p className="text-slate-600 text-xs leading-relaxed">Tendency to experience unpleasant emotions like anger and anxiety.</p>
            </div>
            <div className="bg-white rounded-2xl p-6 text-center shadow-md border-t-4 border-purple-500 transition-all hover:-translate-y-2">
              ...
              <h3 className="text-base font-semibold text-slate-900 mb-2">Openness</h3>
              <p className="text-slate-600 text-xs leading-relaxed">Appreciation for art, emotion, adventure, and intellectual curiosity.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="team" className="bg-white py-16">
        <div className="max-w-5xl mx-auto px-8">
          <h2 className="text-3xl font-bold text-slate-900 text-center mb-10">Our Team</h2>
          ...
          {/* Developers */}
          <h3 className="text-xl font-semibold text-slate-900 text-center mb-6">Development Team</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {developers.map((dev, index) => (
              <div key={index} className="bg-slate-50 rounded-2xl p-7 text-center transition-all hover:-translate-y-2 hover:shadow-lg border border-slate-200">
                <div className="text-5xl mb-4">{dev.avatar}</div>
                <h4 className="text-lg font-semibold text-slate-900 mb-1">{dev.name}</h4>
